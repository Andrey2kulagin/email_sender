    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_group', models.ManyToManyField(blank=True, null=True, to='sender.contactgroup')),
                ('owner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                ('senders', models.ManyToManyField(blank=True, null=True, to='sender.usersenders')),
            ],
        ),
    ]
